...
SitesS=['DomeC', 'VostokSalam', 'DomeFuji', 'EDML','SipleDome','Byrd','LawDome', 'Berkner']#, 'T-UC', 'T-AIS']
...
colors=['r','b','g','k','orange','pink','purple',"darkgreen","gray"]
[print(Tb_Obs[0, j, i] - 273.15 ) for i, j, c in zip(XpixS, YpixS, colors)]
