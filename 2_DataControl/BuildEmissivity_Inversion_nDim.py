...
def GradientDescent(Depth, Emissivity, DeltaLag, MinDeltaLag, Lag, J1,J3, Lambda, Mu, dL, stepE, stepL, Mask, maxiter):
    i=0
    while abs(DeltaLag)>MinDeltaLag and i<maxiter:# and DeltaLag<0:
        OldLag=Lag
...
for t in SliceT:
    ...
    Solve=GradientDescent(Depth, Emissivity, DeltaLag, MinDeltaLag, Lag, J1,J3, Lambda, Mu, dL, stepE, stepL, Mask, maxiter)
    Emissivity=Solve[0]
    Teff=Solve[1]
    L=Solve[2]
    J1=Solve[3]
