...
stepsize =np.concatenate((np.zeros(21).T, [0.], [0.], [0.1], [0.1],np.zeros(21).T,np.zeros(21).T))#Step size for each of the variable: Zeta, H, Acc, Ts, PhiG,LogUh, HDiv, in scaled units
FreeRV_sd= np.reshape(np.concatenate((np.zeros(21).T, [0.], [0.], [3.], [10.], np.zeros(21).T, np.zeros(21).T)),(1,67))
