...
FreeRV_sd= np.reshape(np.concatenate((np.zeros(21).T, [0.], [0.], [3.], [20.], np.zeros(21).T, np.zeros(21).T)),(1,67)) #Standard deviation of the variables, in true physical units
Obs_sd=3#
nbsteps = 1000
